...
| Tag_RISCV_gp_reg_usage              |       14 | uleb128        | Indicates the usage definition of the register.
...
===== Tag_RISCV_gp_reg_usage, 14, uleb128=value

Tag_RISCV_gp_reg_usage indicate the usage of gp register, gp could be used for
...
1:: This object use gp as platform register.
2:: This object use gp as temporary register.

--

Merge policy:::
The linker should report errors if object files of different gp usage
are merged.
...
==== Global-pointer Relaxation
  ...
  Condition:: Global-pointer relaxation require Tag_RISCV_gp_reg_usage must be 0,
...
NOTE: Tag_RISCV_gp_reg_usage treat as 0 if its not presented.
